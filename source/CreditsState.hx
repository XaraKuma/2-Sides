...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Mod Credit'],
		['Swimmy.vs',		'swimmy',		'Director, Icon Artist, 2-Sides Creator, Voice Actor of Mabel',		'https://www.youtube.com/channel/UCr5Y-UjI49K3exuJkW433rw',	0xFF00FFFA],
		['XaraKuma',		'xk',		'Co-Director, Artist, Animator, Charter',		'https://www.youtube.com/channel/UC262w4OpkeazFf0m2Jb2Qsg',	0xFFBB5FFF],
		['Franky',		'frank',		'Composer of Tension',		'https://www.youtube.com/channel/UC1Dny7oizhvdC5EfiSbUA8Q',	0xFFF33131],
		[''],
		['Psych Engine Team'],
